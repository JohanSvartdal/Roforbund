...
@WebServlet(name= "TrenerResultat", urlPatterns = {"/TrenerDash/Resultater/Resultat/"})

public class TrenerResultat extends AbstractAppServlet {
    @Override
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        RequestDispatcher rq = request.getRequestDispatcher("../../../TrenerDash/Resultater/Resultat/index.jsp");
